...
### 3 - Configure your host machine to access the VM.
  ...
  1. [Edit your hosts file](http://docs.rackspace.com/support/how-to/modify-your-hosts-file/), adding the line `192.168.60.3  cluster.k8s.test` so you can connect to the VM.
